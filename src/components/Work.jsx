...
<section className="bg-[#0a192f] dark:bg-gray-900 ">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div className="bg-[#EFF3EA] dark:bg-[#EFF3EA] border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h2 class="text-gray-600 font-extrabold m-3 dark:text-black">Building a Seamless Platform to Help Offline Businesses Expand Their Reach and to Grow in a Competitive Environment</h2>
